...
#define ENABLE_MODULE_COM false
#define ENABLE_MODULE_HTTP true
#define ENABLE_MODULE_UDP_ADC_FORWARD true

#define ENABLE_MODULE_SENSORS_ONE_WIRE true
#define ENABLE_MODULE_SENSORS_ADS1x15 false
#define ENABLE_MODULE_SENSORS (defined(ENABLE_MODULE_SENSORS_ONE_WIRE) && (ENABLE_MODULE_SENSORS_ONE_WIRE == true)) || (defined(ENABLE_MODULE_SENSORS_ADS1x15) && (ENABLE_MODULE_SENSORS_ADS1x15 == true))

#define ENABLE_MODULE_GATE_CONTROLLER false
